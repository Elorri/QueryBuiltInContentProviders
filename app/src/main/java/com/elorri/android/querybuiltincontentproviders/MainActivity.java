...
//        addTieUsContactToContactData("Amaia Mujica", "2130837641", null, null, null, null, "1", "0", "-8271996");
...
//        addTieUsContactToContactData("Monsieur pierre alexaline", "2130837641", null, null, null, null, "1", "0", "-4560696");
...
//        addTieUsContactToContactData("Monsieur pierre mendiboure", "2130837641", null, null, null, null, "1", "0", "-11549705");
...
//        addTieUsContactToContactData("Monsieur roberto murillo", "2130837641", null, null, null, null, "1", "0", "-11677471");
...
//        addTieUsContactToContactData("Monsieur sephane gibout", "2130837641", null, null, null, null, "1", "0", "-10177034");
...
//        addTieUsContactToContactData("Monsieur sylvain jouancastay", "2130837641", null, null, null, null, "1", "0", "-30107");
//        addTieUsContactToContactData("Monsieur sylvain lapart", "2130837641", null, null, null, null, "1", "0", "-11684180");
...
//        addTieUsContactToContactData("Eyharts", "2130837641", null, null, null, null, "0", "0", "-11677471");
    ...
    private void addTieUsContactToContactData(String contactName,
        ...
        Cursor cursor = mContext.getContentResolver().query(
                ...
                ContactsContract.Data.RAW_CONTACT_ID + "=? and " +
                        ...
                        TieUsContract.Contact.CONTACT_ID + "=? and " +
                        TieUsContract.Contact.LOOKUP_KEY + "=? and " +
                        TieUsContract.Contact.SATISFACTION + "=? and " +
                        TieUsContract.Contact.RESPONSE_EXPECTED_TIME_LIMIT + "=? and " +
                        TieUsContract.Contact.RESPONSE_INCREASED_EXPECTED_TIME_LIMIT + "=? and " +
                        TieUsContract.Contact.FREQUENCY_OF_CONTACT + "=? and " +
                        TieUsContract.Contact.LAST_SATISFACTION_DECREASED + "=? and " +
                        TieUsContract.Contact.UNFOLLOWED + "=? and " +
                        TieUsContract.Contact.SATISFACTION_UNKNOWN + "=? and " +
                        TieUsContract.Contact.BACKGROUND_COLOR + "=? ",
                new String[]{convertToNullString(rawContactId),
                        convertToNullString(TieUsContract.Contact.CONTENT_ITEM_TYPE),
                        convertToNullString(contactId),
                        convertToNullString(lookup),
                        convertToNullString(satisfaction),
                        convertToNullString(expectedResponseTimeLimit),
                        convertToNullString(increasedExpectedResponseTimeLimit),
                        convertToNullString(frequencyOfContact),
                        convertToNullString(lastSatisfactionUpdate),
                        convertToNullString(unfollowed),
                        convertToNullString(satisfactionUnknown),
                        convertToNullString(backgroundColor)},
                null);
